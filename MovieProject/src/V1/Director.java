...
public class Director {
	 ...
	 * in der Filme vom Typen Movie gespeichert werden k�nnen.
	 */
	...
	/**
	 * @return id
	 * Gibt die ID des Directors zur�ck.
	 */
	public int getId() {
		return this.id;
	}
	...
	/**
	 * @return name
	 * Gibt den Namen des Directors zur�ck.
	 */
	 ...
	 * Gibt die Liste an Filmen zur�ck, die vom Director
	 * directed wurden.
	 */
	...
	/**
	 * @param movie
	 * F�gt der Liste directedMovies einen neuen Film
	 * vom Typ Movie hinzu.
	 */
